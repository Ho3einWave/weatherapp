...
const WindDirection = ({ data }: { data: WeatherResponse }) => {
    return (
        <motion.div
        ...
        >
            <div className="h-full flex flex-col justify-center font-semibold">
                <div className="text-sm text-nowrap">
                    {degToDirection(data.daily.windDirection10mDominant[1])}
                </div>
                <div className="text-sm">
                    {data.daily.windSpeed10mMax[1].toFixed(1)}km/h
                </div>
            </div>
            <div className="relative h-[80px] w-[80px] border-2 border-zinc-900/50  rounded-full">
                ...
                <motion.div
                    ...
                    whileInView={{
                        ...
                        translateX: "-50%",
                        translateY: "-50%",
                        rotate: data.daily.windDirection10mDominant[1],
